...
class CategoryController extends Controller
{
    ...
    public function store(CreateCategory $request)
    {
        ...
        return redirect()->route('category.index')->with('message', 'failed to add successfully');
    }
    ...
    public function update(UpdateCategory $request, $id)
    {
        ...
        return redirect()->route('category.index')->with('message', 'failed to update successfully');
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('category.index')->with('message', "failed to delete successfully");
    }
}
