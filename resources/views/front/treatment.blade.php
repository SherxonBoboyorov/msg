...
@section('content')
    ...
    <!-- back-img start -->
    <div class="back-img w-full px-3 mx-auto flex justify-start bg-no-repeat bg-center bg-cover items-center h-[220px]" style="background-image: url('{{ asset('front/src/public/images/bac-img.png') }}')">
      <div class="text-content max-w-screen-xl w-full mx-auto h-fit">
        ...
        <div class="decription text-white">
          ...
          -
          <span class="text-[20px]">Treatment in Germany</span>
        </div>
      </div>
    </div>
    <!-- back-img end -->
