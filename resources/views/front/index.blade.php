          ...
          <div class="servises text-center [@media(max-width:576px)]:w-full [@media(min-width:576px)]:w-1/2 [@media(min-width:768px)]:w-1/3 [@media(min-width:992px)]:w-1/4 p-3">
            <div class="services-content flex min-h-full flex-col w-full h-full bg-white rounded-md shadow-[0_2px_14px_0px_rgba(0,0,0,0.10)] px-5 py-7">
              <div class="body w-full mb-3">
                ...
                <div class="text text-[20px] mt-5 font-[500]">Treatment in Germany</div>
              </div>
        ...
        <div class="form-content mx-auto max-w-screen-md">
          <form action="http://uybozorim.sosgroup.uz/uz/save_callback" class="my-3">
            <div class="input-content">
              <input required type="text" class="w-full border border-[#D6D6D6] text-black placeholder:text-black rounded-lg py-3 px-5 my-2.5 text-[18px] outline-none bg-white" placeholder="Name and surname">
              <input required type="email" class="w-full border border-[#D6D6D6] text-black placeholder:text-black rounded-lg py-3 px-5 my-2.5 text-[18px] outline-none bg-white" placeholder="Email">
              <input required type="number" class="w-full border contact-input-number border-[#D6D6D6] text-black placeholder:text-black rounded-lg py-3 px-5 my-2.5 text-[18px] outline-none bg-white" placeholder="Phone number">
              <textarea required type="number" rows="4" class="w-full border contact-input-number border-[#D6D6D6] text-black placeholder:text-black rounded-lg py-3 px-5 my-2.5 text-[18px] outline-none bg-white" placeholder="Your message"></textarea>
            </div>
