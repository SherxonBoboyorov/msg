          ...
          <div class="languages-content flex justify-between items-center">
            ...
            <div class="languages hidden sm:flex justify-between items-center w-fit">
              ...
              @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                <a rel="alternate" hreflang="{{ $localeCode }}" href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}" class=" font-[600] ml-3 text-[16px] hover:text-cred transition-all duration-150">
                  {{ $properties['native'] }}
                </a>
              @endforeach
            </div>
          ...
          <form action="{{ route('saveCallback') }}" class="my-3" method="POST">
            ...
            <div class="button-content mt-7 w-full flex items-center">
              <button id="submitFormBtn" type="submit" disabled
                class="border-none rounded-md disabled:opacity-[0.7] text-[12px] font-[600] bg-cyellow  py-3 px-7">
