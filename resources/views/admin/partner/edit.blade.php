                    ...
                    <div class="card-body">
                        <div class="row" style="margin-top: 15px">
                            <div class="col-md-12">
                                ...
                                <textarea name="content_de" class="my-editor" id="content_de" cols="30" rows="10">{{ $partner->content_de }}</textarea>
                        ...
                        <div class="row" style="margin-top: 15px">
                            <div class="col-md-12">
                                ...
                                <textarea name="content_en" class="my-editor" id="content_en" cols="30" rows="10">{{ $partner->content_en }}</textarea>
                        ...
                        <div class="row" style="margin-top: 15px">
                            <div class="col-md-12">
                                ...
                                <textarea name="content_ru" class="my-editor" id="content_ru" cols="30" rows="10">{{ $partner->content_ru }}</textarea>
