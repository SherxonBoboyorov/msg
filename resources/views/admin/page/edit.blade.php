                ...
                <div class="card-body">
                     <div class="row" style="margin-top: 15px">
                        <div class="col-md-6">
                            ...
                            <textarea name="sub_content_de" class="form-control" id="sub_content_de" cols="30" rows="5">{{ $page->sub_content_de }}</textarea>
                    ...
                    <div class="row" style="margin-top: 15px">
                        <div class="col-md-6">
                            <label for="icon">Homepage Image</label>
                        ...
                        <div class="col-md-6">
                            <img src="{{ asset($page->icon) }}" width="150" height="150" alt="">
                        </div>
                    </div><br><br>
