                        ...
                        <div class="row">
                            <div class="col-md-8">
                              ...
                              <select name="key" id="key" class="form-control">
                                  ...
                                  <option value="address1_de">Address1 DE</option>
                                  <option value="address1_en">Address1 EN</option>
                                  <option value="address1_ru">Address1 Ru</option>
                                  <option value="address2_de">Address2 DE</option>
                                  <option value="address2_en">Address2 EN</option>
                                  <option value="address2_ru">Address2 Ru</option>
                                  ...
                                  <option value="email2">E-mail2</option>
